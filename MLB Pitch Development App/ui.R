        ...
        tabItem(tabName = "var_eff",
                tabBox(
                  ...
                  tabPanel("Break to Tunnel Ratio", 
                           sliderInput("bins_bttr", "Bin Break:", min = 0.1, max = 1, value = 0.5, step = 0.01),
        ...
        tabItem(tabName = "filters",
                ...
                box(
                  ...
                  sliderInput('diffspeed', "Speed Difference", min = -35, max = 0, 
                              value = c(-35,0)),
                  sliderInput('breaktotunnelratio', "Break to Tunnel Ratio", min = 0, max = 40,
                              value = c(0,40), step = 0.5),
                  sliderInput('releasetotunnelratio', "Release to Tunnel Ratio", min = 0, max = 2,
                              value = c(0,2), step = 0.05),
